...
export const PRICING_TIERS: readonly PricingTier[] = [
  {
    id: "single",
    name: "1 Photo Credit",
    displayName: "Single Photo Credit",
    price: "$10",
    priceAmount: 10,
  ...
  {
    id: "5-photos",
    name: "5 Photo Credits",
    displayName: "5 Photo Credits",
    price: "$45",
    priceAmount: 45,
    priceId: "price_1SD8nJIG3TLqP9yaGAjd2WdP",
    credits: 5,
    perPhoto: "$9 per photo credit",
    perPhotoAmount: 9,
  ...
  {
    id: "10-photos",
    name: "10 Photo Credits",
    displayName: "10 Photo Credits",
    price: "$85",
    priceAmount: 85,
    priceId: "price_1SD8nNIG3TLqP9yazPngAINO",
    credits: 10,
    perPhoto: "$8.5 per photo credit",
    perPhotoAmount: 8.5,
  ...
  {
    id: "20-photos",
    name: "20 Photo Credits",
    displayName: "20 Photo Credits",
    price: "$160",
    priceAmount: 160,
    priceId: "price_1SD8nQIG3TLqP9yaBVVV1coG",
    credits: 20,
    perPhoto: "$8 per photo credit",
    perPhotoAmount: 8,
  ...
  },
  {
    ...
    displayName: "50 Photo Credits",
    price: "$375",
    priceAmount: 375,
    priceId: "price_1SD8nTIG3TLqP9yaTOhRMNFq",
    credits: 50,
    perPhoto: "$7.5 per photo credit",
    perPhotoAmount: 7.5,
  ...
  {
    id: "100-photos",
    name: "100 Photo Credits",
    displayName: "100 Photo Credits",
    price: "$700",
    priceAmount: 700,
    priceId: "price_1SD8nWIG3TLqP9yaH0D0oIpW",
    credits: 100,
    perPhoto: "$7 per photo credit",
    perPhotoAmount: 7,
